...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='VG-iT forecasting experiment runner')
    ...
    parser.add_argument('--use_variable_resolution', type=int, default=1, help='whether to use hierarchical structure')
    parser.add_argument('--use_interaction_bridge', type=int, default=1, help='whether to use the gated interaction bridge')
    ...
    parser.add_argument('--use_reorder', type=int, default=0, help='apply deterministic variate reordering by grouping method')
    parser.add_argument('--summary_file', type=str, default='summary.csv', help='summary file name for isolated experiments')
    parser.add_argument('--noise_std', type=float, default=0.0, help='standard deviation of Gaussian noise to inject into inputs')
    ...
    parser.add_argument('--custom_grouping_method', type=str, default='none',
                        ...
                        help='Custom graph-based grouping method. none=use existing grouping_method.')
        ...
        for ii in range(args.itr):
            ...
            if requires_group_plan:
                ...
                if use_custom_grouping:
                    # Use graph-based custom grouping
                    print(
                    ...
                    group_sizes = None  # Force uniform window partitioning; use permutation only.
