...
- Figure 6: `python figure_generation/scripted_figures/fig6_probing_confusion/generate_figure_6.py`
- Supplementary Figure S1: `python figure_generation/scripted_figures/supp_fig_s1_winrate/generate_supplementary_figure_s1.py`
- Supplementary Figure S2: `python figure_generation/scripted_figures/supp_fig_s2_epoch1/generate_supplementary_figure_s2.py`
