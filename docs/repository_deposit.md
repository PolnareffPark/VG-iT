...
This document describes the cleaned public repository root and immutable DOI-deposit payload for VG-iT v1.0.0.
...
- `results_canonical/`: curated result files used by the manuscript, organized by analysis family.
